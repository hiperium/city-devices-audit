...
mvn clean process-classes                       \
    -f functions/trail-create-function/pom.xml  \
    -P tracing-agent
```

Then, navigate to the `functions/trail-create-function/src/test/http/local.http` file, and execute the requests
...
```bash
cp -rf functions/trail-create-function/target/native-image/* \
       functions/trail-create-function/src/main/resources/META-INF/native-image
```
